...
// Cross-tab kanal (samme maskin). For tvers av enheter bruker vi Firebase for ønsker.
    ...
    <AppWrap>
      ...
      <TopBar>
        ...
        <Nav>
          ...
          <NavButton onClick={go("/screen")}>Storskjerm</NavButton>
        ...
        <Panel>
          ...
          <Form onSubmit={onSubmit}>
            ...
            <div>
              ...
              <TextArea
                placeholder="Skriv ønsket ditt her…"
                value={wish}
